"""
File: test_ch7.py
Purpose: One or more tests for Try It Yourself in ch7
"""
...
class TestCh7TIY(unittest.TestCase):
    ...
    # to avoid manually entering data for tests that passed in this module
    #   correct tests commented out
    #
    ...
    #     self.assertEqual(1, 1)
    #
    # def test_movie_tickets_7_7(self): # Did it
    #
